...
function handlePostback(senderPsid, receivedPostback) {
  ...
  if (payload === "yes") {
    ...
    response = { text: "Thank you 10/12/2023" };
  } else if (payload === "no") {
...
async function customerAddress(senderPsid) {
    ...
    message: {
      attachment: {
        ...
        payload: {
          ...
          business_privacy: "https://www.facebook.com/privacy/explanation",
          expires_in_days: 1,
        },
      },
    },
  ...
  const response = await fetch(
    `https://graph.facebook.com/v18.0/110403342158265/messages?access_token=${PAGE_ACCESS_TOKEN}`,
    {
      method: "POST",
      headers: {
